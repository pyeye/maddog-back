...
class Reservation(models.Model):
    ...
    phone_number = models.CharField(max_length=17, validators=[phone_regex], null=True, blank=False, verbose_name='Телефон')
    ...
    status = models.CharField(max_length=128, default='Ожидает', null=False, blank=True, verbose_name='Статус')
